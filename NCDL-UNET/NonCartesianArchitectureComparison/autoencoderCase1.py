...
class NCDL(nn.Module):
    def __init__(self, lattice: ncdl.Lattice, num_classes=10):
        ...
        self.layer17 = nn.Sequential(
            ncnn.LatticeUnwrap(),
            nn.ConvTranspose2d(1024, 512, kernel_size=4, stride=2, padding=0, output_padding=1),
        ...
        self.layer21 = nn.Sequential(
            ncnn.LatticeUnwrap(),
            nn.ConvTranspose2d(256, 128, kernel_size=4, stride=2, padding=0, output_padding=1),
...
#         print(out.shape)
        out = layer(out)
        restore5 = downsample(out, np.array([[-1, 1], [1, 1]], dtype='int'))
        out = self.layer11(restore5)
