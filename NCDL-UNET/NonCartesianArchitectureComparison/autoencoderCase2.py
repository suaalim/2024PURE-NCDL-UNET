...
class NCDL(nn.Module):
    def __init__(self, lattice: ncdl.Lattice, num_classes=10):
        ...
        self.layer17 = nn.Sequential(
            ncnn.LatticeUnwrap(),
            nn.ConvTranspose2d(1024, 729, kernel_size=4, stride=2, padding=0),
        ...
        self.layer19 = nn.Sequential(
            ncnn.LatticeUnwrap(),
            nn.ConvTranspose2d(486, 324, kernel_size=4, stride=2, padding=0),
        ...
        self.layer21 = nn.Sequential(
            ncnn.LatticeUnwrap(),
            nn.ConvTranspose2d(216, 144, kernel_size=4, stride=2, padding=0),
        ...
        self.layer26 = nn.Sequential(
            ncnn.LatticeUnwrap(),
            nn.ConvTranspose2d(96, 64, kernel_size=4, stride=2, padding=0),
...
for epoch in range(num_epochs):
    ...
    with torch.no_grad():
        ...
        for images, masks in valid_loader:
            ...
            val_correct += accuracy * torch.numel(outputs)
            val_total += torch.numel(outputs)
